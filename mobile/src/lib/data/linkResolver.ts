...
const LOGIN_WALL_PHRASES = [/you must be logged in to view this link/i, /sign in to see/i]
...
function looksLikeContestPage(html: string): boolean {
  ...
  return /(?:gleam\.io|woobox\.com|rafflecopter\.com)/i.test(html)
}
